...
void makeplots() {
  ...
  files[0] = "/mercury/data2/ben/SHERPA-MC-2.2.7/bfuller/subPlotM/t1sM/bothOut.root";
  files[1] = "/mercury/data2/ben/SHERPA-MC-2.2.7/bfuller/subPlotM/t1sM/bckgrdOut.root";
  files[2] = "/mercury/data2/ben/SHERPA-MC-2.2.7/bfuller/subPlotM/t1sM/signalOut.root";
...
void analyse(const TString inputFiles[3],double gam,double mhp)
{
  ...
  double CrossSection[3] = {0.1439,0.1197,0.02205};
  for (int isb=0;isb<3;++isb) {  
